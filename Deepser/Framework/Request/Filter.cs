...
namespace Deepser.Framework.Request
{
    ...
    public class Filter
    {
        ...
        public Filter addFilter(string _attribute, string _operator, string _value)
        {
            filters[_attribute] = new OtherFilter { Operator = _operator, Value = _value };
            return this;
        }

        public Filter addFilter(string _attribute, string _operator, int _value)
        {
            filters[_attribute] = new OtherFilter { Operator= _operator, Value = _value }; 
            return this;
        }
